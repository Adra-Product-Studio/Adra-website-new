...
export function OrbitDiagram({
  ...
  const nodePositions = [
    { x: 92, y: 226, align: "end" as const },
    { x: 112, y: 186, align: "end" as const },
    { x: 176, y: 138, align: "start" as const },
    { x: 224, y: 152, align: "start" as const },
    { x: 262, y: 188, align: "start" as const },
    { x: 296, y: 236, align: "start" as const }
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <g transform="translate(160 160) scale(1.2) translate(-160 -160)">
          {/* Phase 1: Fuzziness */}
          <g opacity="1">
            <animate
