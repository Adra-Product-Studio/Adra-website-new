...
export function OrbitDiagram({
  ...
  const nodePositions = [
    { x: 106, y: 224, align: "end" as const },
    { x: 124, y: 184, align: "end" as const },
    { x: 176, y: 140, align: "start" as const },
    { x: 226, y: 156, align: "start" as const },
    { x: 268, y: 196, align: "start" as const },
    { x: 300, y: 238, align: "start" as const }
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <g transform="translate(160 160) scale(1.22) translate(-160 -160)">
          {/* Phase 1: Fuzziness */}
          <g opacity="1">
            <animate
