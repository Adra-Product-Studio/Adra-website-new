...
export default function HomePage() {
  return (
    <div id="top" className="relative bg-noise">
      ...
      {/* Startups */}
      <section id="startups" className="container scroll-mt-24 py-16">
        <SectionHeading
          eyebrow="Startups"
      ...
      {/* Enterprises */}
      <section id="enterprises" className="border-t">
      ...
      {/* Capabilities */}
      <section id="capabilities" className="container scroll-mt-24 py-16">
        <SectionHeading
      ...
      {/* Engagement */}
      <section id="engagement" className="border-t">
        <div className="container scroll-mt-24 py-16">
          <SectionHeading
            eyebrow="Engagement"
      ...
      {/* Clients */}
      <section id="clients" className="container scroll-mt-24 py-16">
        <SectionHeading
          eyebrow="Clients"
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {clientLinks.map((c) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group rounded-2xl border bg-background/60 p-6 transition-colors hover:bg-muted/30"
            >
